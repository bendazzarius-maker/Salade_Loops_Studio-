...
(function initSamplePatternEditor(global) {
  ...
  previewBtn?.addEventListener("pointerup", () => stopPreviewLoop());
  previewBtn?.addEventListener("pointerleave", () => stopPreviewLoop());
  previewBtn?.addEventListener("pointercancel", () => stopPreviewLoop());
